...
namespace LMSWarehouse
{
    class Wrapper
    {
        ...
        {
            //string constring = "Password=Mosselbaai1;Persist Security Info=True;Connect Timeout=1800;User ID=christo;Initial Catalog=lmswmsTEST;Data Source=41.185.18.178;Min Pool Size=5;Max Pool Size=2000";
            string constring = "Password=Mosselbaai1;Persist Security Info=True;Connect Timeout=30000;User ID=christo;Initial Catalog=lmswms;Data Source=41.185.18.178;Min Pool Size=5;Max Pool Size=2000";
        ...
        {
            string LData = @"Password=mosselbaai;Persist Security Info=True;Connect Timeout=30000;User ID=christocc;Initial Catalog=logidatacc;Data Source=41.185.18.34,1444;Min Pool Size=5;Max Pool Size=2000";
            return LData;
        }
        ...
        public DataSet GetWarehouseStock(int WarehouseID)
        {
            SqlConnection myconnection = new SqlConnection(GetConnection());
            SqlDataAdapter da = new SqlDataAdapter("[sp_stock_GetWarehouseStock]", myconnection);
            da.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public int SetStockOrderBatch(int ProductID, string SKU, int Length, int Width,
            int Height, double Weight, double Amount, int Parts, string Barcode,DateTime DateBatch)
        {
            string constring = GetConnection();
        ...
        public DataSet GetCompleteOrders(int WarehouseID, string OrderType, DateTime DateFrom)
        {
            //Using datareader
            //SqlConnection myconnection = new SqlConnection(GetConnection());
            //SqlCommand cm = new SqlCommand("[sp_stock_GetCompleteOrders]", myconnection);
            //SqlDataReader da;
        ...
        public DataSet GetPickItemLis(int OrderID)
        {
            SqlConnection myconnection = new SqlConnection(GetConnection());
